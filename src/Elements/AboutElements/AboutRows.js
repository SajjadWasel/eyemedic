    ...
    return (
        <div>
            <div className='half_background'>
                <div>
                    <img className='w-100 h-100' src="https://images.pexels.com/photos/40568/medical-appointment-doctor-healthcare-40568.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                </div>
                <div className="bg_orangred p-5">
                    <h1 data-aos="zoom-in-up" className='text-light'>This is Heading</h1>
            ...
            <div className='half_background'>
                ...
                <div>
                    <img className='w-100 h-100' src="https://images.pexels.com/photos/347141/pexels-photo-347141.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                </div>
            </div>
            ...
            <div className='half_background'>
                <div>
                    <img className='w-100' src="https://images.pexels.com/photos/443383/pexels-photo-443383.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                </div>
                <div className="bg_orangred p-5">
                    <h1 data-aos="zoom-in-up" className='text-light'>This is Heading</h1>
                    <p className="text-light pb-3">
